...
<nav class="navbar navbar-expand-md fixed-top top-nav">
	<div class="container">
		  <a class="navbar-brand" href="#"><strong>Grade Boosters Tutorials</strong></a>		 
		   <a class="hm-login-link"  data-toggle="modal" href="#myModal">Sign In</a>		  
	</div>
</nav>
...
<section class="intro carousel slide bg-overlay-light h-auto" id="carouselExampleCaptions">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="carousel-item active">
        ...
        <h2 class="display-4 text-white mb-2 mt-4">Fast Access to E-Books</h2>
      ...
      <div class="carousel-item">
        ...
        <div class="carousel-caption ">
          	<h2 class="display-4 text-white mb-2 mt-4">Well Responsive Website</h2>
...
<section class="info-section">
	<div class="container">
		<div class="head-box text-center mb-5">
			<h2 class="text-underline-primary">Achieving Excellence Together</h2>
		</div>
